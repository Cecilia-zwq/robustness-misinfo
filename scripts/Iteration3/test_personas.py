...
Place this file in the Iteration3/ directory (same level as misinfo_eval_framework/).

To run:
    cd Iteration3
    /home/wzhan969/miniconda3/envs/misinfo/bin/python test_personas.py
"""
...
N_TURNS = 4  # short run for testing
